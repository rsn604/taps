...
func (p *Panel)Read()(k tcell.Key, n string)
```

### (2) Store data to Field 
```
func (p *Panel)Store(s string, n string)
...
```
func (p *Panel)GetFieldNumber(n string)(int)
...
```
func (p *Panel)GetDataField(n string)(*DataField)

func (p *Panel)GetDataFieldWithNumber(n string)(*DataField, int)
```

### (8) List
```
func (p *Panel)GetListFocus(n string)(int)
